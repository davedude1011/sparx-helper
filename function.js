...
document.addEventListener('keydown', function (event) { // testing functions
    // Check if the pressed key is 'L'
    if (event.key === 'L' || event.key === 'l') {
      // Call the function when 'L' key is pressed
      RemoveUselessMenuItems()
    }
});